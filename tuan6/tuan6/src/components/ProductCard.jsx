...
const ProductCard = ({ product }) => {
  ...
  return (
    <div className="group bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden">
      {/* Image */}
      ...
      <div className="p-4 sm:p-5">
        ...
        <div className="mt-4 flex items-center justify-between">
          ...
          <button
            ...
            className={`
              inline-flex items-center gap-1.5 px-4 py-2 text-sm font-semibold rounded-xl
